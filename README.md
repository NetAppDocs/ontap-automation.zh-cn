...
Welcome to the open-source documentation for the ONTAP REST API and related automation technologies.
...
If you'd like to view the documentation, go to https://docs.netapp.com/us-en/ontap-automation/
