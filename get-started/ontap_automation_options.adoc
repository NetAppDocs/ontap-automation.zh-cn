...
.NetApp Console自动化中心
这 https://console.netapp.com/automationHub["NetApp Console自动化中心"^] 可通过控制台 Web 用户界面访问。自动化中心提供对打包解决方案的访问，可以帮助您自动部署ONTAP并将其与其他产品集成。看 https://docs.netapp.com/us-en/netapp-automation/["NetApp自动化"^] 有关文档和更多信息，请参阅相关文件。
