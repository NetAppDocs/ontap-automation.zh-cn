...
NOTE: ONTAP RBAC功能继续扩展、并在ONTAP 9.11.1 (及后续版本)中得到了显著增强。请参见 link:../rest/rbac_overview.html#summary-of-rbac-evolution["RBAC演变概述"] 和 link:../whats_new.html["ONTAP REST API 和自动化的新增功能"] 有关详细信息 ...
